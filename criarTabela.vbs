...
session.findById("wnd[0]/usr/tabsTAB_STRIP/tabDEF/ssubTS_SCREEN:SAPLSD41:2201/tblSAPLSD41TC0/txtDD03D-FIELDNAME[0,0]").text = "MANDT"
session.findById("wnd[0]/usr/tabsTAB_STRIP/tabDEF/ssubTS_SCREEN:SAPLSD41:2201/tblSAPLSD41TC0/txtDD03D-FIELDNAME[0,0]").setFocus
session.findById("wnd[0]/usr/tabsTAB_STRIP/tabDEF/ssubTS_SCREEN:SAPLSD41:2201/tblSAPLSD41TC0/txtDD03D-FIELDNAME[0,0]").caretPosition = 5

session.findById("wnd[0]/usr/tabsTAB_STRIP/tabDEF/ssubTS_SCREEN:SAPLSD41:2201/tblSAPLSD41TC0/chkDD03P-KEYFLAG[1,0]").selected = true
session.findById("wnd[0]/usr/tabsTAB_STRIP/tabDEF/ssubTS_SCREEN:SAPLSD41:2201/tblSAPLSD41TC0/chkDD03P-NOTNULL[2,0]").selected = true
session.findById("wnd[0]/usr/tabsTAB_STRIP/tabDEF/ssubTS_SCREEN:SAPLSD41:2201/tblSAPLSD41TC0/txtDD03D-ROLLNAME[3,0]").text = "MANDT"
session.findById("wnd[0]/usr/tabsTAB_STRIP/tabDEF/ssubTS_SCREEN:SAPLSD41:2201/tblSAPLSD41TC0/txtDD03D-ROLLNAME[3,0]").setFocus
session.findById("wnd[0]/usr/tabsTAB_STRIP/tabDEF/ssubTS_SCREEN:SAPLSD41:2201/tblSAPLSD41TC0/txtDD03D-ROLLNAME[3,0]").caretPosition = 5
